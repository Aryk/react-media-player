...
class MuteUnmute extends Component {
  ...
  render() {
    const { volume, isMuted, className, toggleMute } = this.props;
    const showVolume = isMuted ? 0 : volume;

    return (
      <svg width="36px" height="36px" viewBox="0 0 36 36" className={className} onClick={toggleMute}>
